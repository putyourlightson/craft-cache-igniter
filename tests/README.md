...
```shell
php vendor/bin/pest --test-directory=vendor/putyourlightson/craft-cache-igniter/tests/pest
```

Or to run a specific test.

```shell
php vendor/bin/pest --test-directory=vendor/putyourlightson/craft-cache-igniter/tests/pest --filter=CacheRequestTest
```
